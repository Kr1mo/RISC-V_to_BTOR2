...
BENCHMARK_DIR="benchmark_files/fullmem"
TEMP_DIR="benchmark_files/temp_files"
# Log file to store timing results
LOG_FILE="benchmark_files/bench_fullmem_${identifier}.log"
...
echo "Benchmarking fullmem completed. Results saved in $LOG_FILE."