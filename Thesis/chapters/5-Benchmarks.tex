...
Now only the instruction flags and with them the only property are
left to handle:
\begin{center}
...
into \tabref{tab:time_extaddr}. Also to get an overview of the times,
I plotted the times of \tabref{tab:time_iter} in
\figref{fig:benchIterPlot}. From \tabref{tab:time_extaddr} one can
