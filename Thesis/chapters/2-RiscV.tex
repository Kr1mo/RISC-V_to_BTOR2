...
In RV64I, memory addresses are 64 bits in size. As the memory model is defined to
...
one of the six formats illustrated in \figref{fig:rv64i_formats}.
...
I have divided the instructions in \tabref{tab:rv64i-instructions} into nine groups based on their operations.
...
For this purpose, I have devised the format shown in \figref{statefileform}. The minimal file consists only of the two designators \dq REGISTERS:\dq\ and \dq MEMORY:\dq, the current $pc$, and one empty line.
