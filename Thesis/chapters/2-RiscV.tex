...
I splitted the instructions of \tabref{tab:rv64i-instructions} into nine groups based on their operations.
...
\todo{Vielleicht besser aufgehoben in Kap.4, aber statefile relevant.}
...
For this I devised the format as shown in \figref{statefileform}. The minimal file only consists of the two designators \dq REGISTERS:\dq \& \dq MEMORY:\dq, the current $pc$ and one empty line.
